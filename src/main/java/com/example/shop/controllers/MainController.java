...
@Controller
@RequestMapping("/") //отслеживает пустую страницу
public class MainController {
    ...
    @GetMapping //обработай GET запрос
    public String getMainPage(Model model){
        List<ItemModel> list = itemRepository.findAll();
        list=list.stream().limit(5).collect(Collectors.toList()); //стрим, в котором мы оставляем только 5 элементов
